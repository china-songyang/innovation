 		...
 		<div class="con22">
 			<div class="con22_top"></div>
           	  <div class="con22_main">
           	 	 <center>
           	 		<div style=""><br><br><br><br><br><br><img src="<%=request.getContextPath()%>/innovation/images/sucess.png"></div><div style="margin-top:6px;height:30px;line-height: 30px;font-size:16px;">留言成功，多谢您的宝贵意见!</div>
           	 	</center>
            </div>
